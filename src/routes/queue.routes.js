...
// جلب بيانات الشاشة: يسمح للجميع بما فيهم دور DISPLAY للشاشات
router.get('/display/all', authorize(['RECEPTION', 'DOCTOR', 'ADMIN', 'SUPER_ADMIN', 'DISPLAY']), queueController.getAllDisplay);
